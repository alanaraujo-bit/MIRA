...
type Analytics = { link: LinkItem; range: { days: number; startsAt: number; endsAt: number }; clicks: Comparison; sessions: Comparison;
  ...
  sources: Breakdown[]; devices: Breakdown[]; countries: Breakdown[]; operatingSystems: Breakdown[];
