...
export default function CampaignsApp({ user }: { user: { displayName: string; email: string } }) {
  ...
  return <div className="product-shell">
    ...
    <aside className="product-sidebar">
      ...
      <nav aria-label="Produto"><Link href="/product"><span aria-hidden="true">⌂</span>Visão geral</Link><Link href="/product#links"><span aria-hidden="true">↗</span>Links</Link><Link className="selected" href="/product/campaigns"><span aria-hidden="true">◇</span>Campaigns</Link><Link href="/product/domains"><span aria-hidden="true">◎</span>Domínios</Link><Link href="/product/analytics"><span aria-hidden="true">◌</span>Analytics</Link></nav>
