...
export default function PrivacyPage() {
  return <main className="privacy-page">
    ...
    <article>
      ...
      <section><span>01</span><div><h2>Quando alguém abre um Link</h2><p>A Mira registra o Link e Workspace responsáveis, horário, host de referência quando o navegador o fornece e categorias reduzidas de dispositivo, sistema, navegador e idioma. País e região aproximados podem ser informados pela infraestrutura de entrega a partir da rede.</p><p>O produto não persiste endereço IP, user-agent bruto, cidade, coordenadas ou CEP em Analytics. Geografia pode estar ausente ou incorreta por causa de VPN, proxy e características da rede.</p></div></section>
