      ...
      <main id="main">
        ...
        <section className="evidence-grid" id="releases">
          ...
          <div className="evidence-columns">
            <article className="evidence-card"><header><span>Release atual</span><strong>{project.release}</strong></header><h3>Foundation</h3><p>Marca, princípios, arquitetura e Roadmap Live. Nenhum recurso de cliente é apresentado como pronto.</p><dl><div><dt>Ambiente</dt><dd>{project.environment}</dd></div><div><dt>Commit</dt><dd>{project.commit}</dd></div><div><dt>Saúde</dt><dd className="status-inline active">Em validação</dd></div></dl></article>
